...
- substitution 和 transposition 可以通过电路硬件实现。
    ...
    ![image-20241221100404993](static/image-20241221100404993.png)
...
- triple DES
    ...
    ![image-20241221102259222](static/image-20241221102259222.png)
...
- CBC mode（Cipher Block Chaining mode，密码分组链接）
    ...
    ![image-20241221104901451](static/image-20241221104901451.png)
...
- CFB mode（Cipher Feedback Mode，密码反馈）
    ...
    ![image-20241221105618045](static/image-20241221105618045.png)

- Stream Cipher Mode
    - 反复加密IV得到不重复的 keystream
    - 绝对不能两次使用相同的IV，会受到 keystream reuse attack
	![image-20241221110840508](static/image-20241221110840508.png)
...
- X.509
    ...
    - 某人的X.500地址可能是`/C=US/O=MoneyBank/OU=Loan/CN=Bob/`，其中C代表国家，O代表组织，OU代表组织单位，CN代表通用名称。
        - 从 version 3 开始，允许使用DNS names 代替X.500名称
...
- IPsec的两个组成部分
    - 可以添加到数据包中的两个新头。
        ...
        - AH（Authentication Header，认证头）
            ...
            ![image-20241221141409253](static/image-20241221141409253.png)
        ...
        - ESP（Encapsulating Security Payload，封装安全载荷）
            ...
            ![image-20241221143245042](static/image-20241221143245042.png)
...
- SSL位于传输层与应用层之间，接受浏览器的请求并将它们发送到TCP以传输到服务器。
    ...
    ![image-20241221121123537](static/image-20241221121123537.png)
